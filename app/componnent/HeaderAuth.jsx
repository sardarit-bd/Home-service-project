                                ...
                                <div className="p-4 bg-white border border-gray-200 rounded-lg tooltipscostom">
                                    <div className="flex flex-col gap-2">
...

                                        {
                                            loginUser?.role !== "user" && (
                                                <>
                                                    <Link href={`${loginUser?.role === "admin" ? "/deshboard/admin" : loginUser?.role === "provider" ? "/deshboard/provider" : "/"}`} className="text-gray-600 text-md font-semibold hover:bg-gray-200 rounded-md p-2 flex items-center gap-2">
