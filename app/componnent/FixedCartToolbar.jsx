...
const FixedcartToolbar = () => {
    ...
    return (
        <Link className="bg-sky-400 text-white fixed top-[200px] p-3 rounded-l-md shadow-lg right-0 z-90 hover:bg-sky-500 transition-all duration-300 hidden md:block" href={'/'}>
            <House size={24} />
            {cart.length > 0 && (
