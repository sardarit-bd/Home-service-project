...
export default function HeroSection() {
    return (
        <section className="relative h-[95vh] bg-whtie text-black overflow-hidden py-16 md:py-24">
            ...
            <div className="container mx-auto px-2 md:px-7 text-center md:text-left">
                {/* Headline */}
                <motion.h1
                ...
                >
                    ...
                    />
                    <button className="bg-[var(--brandColor,#00a6f4)] text-white px-6 py-2 rounded-full font-semibold hover:opacity-90 transition-all">
                        Search
                    </button>
                </motion.div>
