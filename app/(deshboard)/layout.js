    ...
    <div className="h-fit text-black">
      {!isSideberOpen && (
        <div
          ...
          className={`absolute flex lg:hidden z-50 bg-sky-400 text-white  items-center justify-center rounded-md  p-2 -translate-x-3 mt-4 cursor-pointer`}
        >
      ...
      <div className="">
        ...
        >
          <div
            ...
            className={`absolute w-[25px] h-[25px] right-0 top-0 bg-sky-300 rounded-sm cursor-pointer text-white flex lg:hidden items-center justify-center hover:rotate-180 transition duration-400`}
          >
            <RxCross2 className="" />
          </div>
